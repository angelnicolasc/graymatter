...
```bash
# Linux (x86_64)
curl -sSL https://github.com/angelnicolasc/graymatter/releases/download/v0.12.1/graymatter_0.12.1_linux_amd64.tar.gz | tar -xz && sudo mv graymatter /usr/local/bin/

# macOS (Apple Silicon)
curl -sSL https://github.com/angelnicolasc/graymatter/releases/download/v0.12.1/graymatter_0.12.1_darwin_arm64.tar.gz | tar -xz && sudo mv graymatter /usr/local/bin/
