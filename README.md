...
```bash
# Linux (x86_64)
curl -sSL https://github.com/angelnicolasc/graymatter/releases/download/v0.16.1/graymatter_0.16.1_linux_amd64.tar.gz | tar -xz && sudo mv graymatter /usr/local/bin/

# macOS (Apple Silicon)
curl -sSL https://github.com/angelnicolasc/graymatter/releases/download/v0.16.1/graymatter_0.16.1_darwin_arm64.tar.gz | tar -xz && sudo mv graymatter /usr/local/bin/

# Windows (PowerShell)
iwr https://github.com/angelnicolasc/graymatter/releases/download/v0.16.1/graymatter_0.16.1_windows_amd64.zip -OutFile graymatter.zip
...
*GrayMatter — v0.16.1 — August 2026*
