...
- All commits SSH-signed and GitHub-verified under `angelnicolasc <108889887+angelnicolasc@users.noreply.github.com>`. No `Co-Authored-By: Claude` trailers — ever. Co-author humans where appropriate.
- Branches off `main`. Direct push to `main` is allowed for this repo per owner preference; PRs are opened only when external review is wanted.
