...
## Extractor v2 � re-medici�n tras las mejoras deterministas (2026-08-23)
...
comandos, corpus id�ntico:

| M�trica | v1 (antes) | **v2 (despu�s)** |
|---|---|---|
...
de una segunda menci�n por apellido (clase conocida), m�s dos `registrar`
capturados por la regla nueva de roles contextuales donde el gold no los
anotaba � casos l�mite de anotaci�n, documentados sin ajustar el gold.

Pendiente: re-corrida del multi-hop bench con este extractor para re-evaluar
la condici�n 2 del gate ADR-003 (EnrichedHitRate > baseline).
