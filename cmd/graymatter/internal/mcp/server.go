...
func (s *Server) registerTools() {
	...
	s.mcpSrv.AddTool(
		mcp.NewTool("memory_reflect",
			mcp.WithDescription("Add, update (supersede), forget, link, or pin your memories. Use when you notice a contradiction, finish a task, learn a durable preference that should persist, or the user declares something permanent (a standing obligation, an architecture decision) that must never decay."),
			writeTool(),
